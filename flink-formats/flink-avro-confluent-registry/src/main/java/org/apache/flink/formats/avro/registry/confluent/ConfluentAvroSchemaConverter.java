 ...
 */
public class ConfluentAvroSchemaConverter {
     ...
     */
    public static Schema convertToSchema(LogicalType schema, String fallbackSchema) {
        return convertToSchema(schema, fallbackSchema, true);
    }
    ...
    public static Schema convertToSchema(
        ...
        switch (logicalType.getTypeRoot()) {
            ...
            case VARCHAR:
                ...
                // Check fallback schema for enum handling
                if (fallbackSchema != null && fieldName != null) {
                    Schema parsedSchema = new Schema.Parser().parse(fallbackSchema);
                    str = parsedSchema.getField(fieldName).schema();
                } else {
                    str = SchemaBuilder.builder().stringType();
                }
